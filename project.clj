...
(defproject spellhouse/clairvoyant VERSION
  ...
  :clean-targets ^{:protect false} ["dev-resources/public/out" "resources/public/out" "target"]

  :cljsbuild {:builds {:app {:source-paths ["src"]
                             :compiler     {:output-to     "dev-resources/public/clairvoyant.js"
  ...
  :release-tasks [["clean"]
                  ["with-profiles" "-dev,+release" "cljsbuild" "once"]
                  ["jar"]]
  ...
  {:dev     {:dependencies [[com.cemerick/piggieback "0.1.3"]
             ...
             :cljsbuild    {:builds {:app {:source-paths ["dev"]}}}}

   :release {:cljsbuild {:jar    true
                         :builds {:app {:compiler {:output-to     "resources/public/clairvoyant.js"
